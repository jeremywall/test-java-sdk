...
public class SignatureCalculator {
    ...
    public String calculateStationsSignature(
            String apiKey,
            String apiSecret,
            long apiRequestTimestamp) throws NoSuchAlgorithmException, InvalidKeyException {
    ...
    public String calculateStationsSignature(
            ...
            String stationIds) throws NoSuchAlgorithmException, InvalidKeyException {
    ...
    private String calculateSignature(
            ApiCall apiCall,
            String apiSecret,
            Map<String, String> parametersToHash) throws NoSuchAlgorithmException, InvalidKeyException {

        String stringToHash = parametersToHash.entrySet().stream().sorted(Comparator.comparing(Map.Entry::getKey)).map(entry -> entry.getKey() + entry.getValue()).collect(Collectors.joining());
